...
- v5.13 - Pool Depth and Quote-Size Ladder Evidence for testing Base ETH route impact at increasing sizes and feeding depth-aware evidence into Execution Realism.

## Next

- v5.14 - Depth-aware route sizing recommendations and market-regime-aware confidence.
- v5.15 - Walk-forward explainability and stability scoring.
