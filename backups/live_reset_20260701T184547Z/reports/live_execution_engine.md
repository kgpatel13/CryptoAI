...
- Next unblock step: `Atomic executor rejected the route as ProfitTooLow: simulated output 4.941833 USDC, required 5.0005 USDC.`
...
|---|---|---|---|
| atomic_live_arbitrage | atomic_route_simulation_passed | BLOCK | Atomic executor rejected the route as ProfitTooLow: simulated output 4.941833 USDC, required 5.0005 USDC. |
