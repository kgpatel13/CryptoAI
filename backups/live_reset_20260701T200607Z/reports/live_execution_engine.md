...
- Next unblock step: `Atomic executor rejected the route as ProfitTooLow: simulated output 0.995186 USDC, required 1.0001 USDC.`
...
|---|---|---|---|
| atomic_live_arbitrage | atomic_route_simulation_passed | BLOCK | Atomic executor rejected the route as ProfitTooLow: simulated output 0.995186 USDC, required 1.0001 USDC. |
