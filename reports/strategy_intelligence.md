...
Generated: `2026-06-30T07:46:46Z`

## Summary

- Mode: `paper`
- Strategies: `5`
- Top recommendation: `HOLD_FIX_OPERATIONS`
- Promotion allowed: `False`
- Provider status: `OK`
- Experiment: `WATCHLIST` with `0` fail / `1` warn
- Report audit findings: `27`
- Replay production trades: `410` at `0.30` cost buffer
- Replay best profitable buffer: `0.20` with `932` trade(s)
...
- Pool depth ladder: `DEPTH_EVIDENCE_WATCH` with `LOW` confidence and `0/2` ready route(s)

## Strategies

| Strategy | Enabled | Score | Recommendation | Filled | Closed | PnL | Win Rate | Blockers |
|---|---:|---:|---|---:|---:|---:|---:|---|
| DEX Arbitrage Strategy | True | 54 | HOLD_FIX_OPERATIONS | 0 | 0 | 0.0000 | None | Live trading is disabled; this is advisory paper intelligence only.; Report audit has 27 finding(s).; Execution cost evidence is insufficient.; ETH route evidence keeps 0.20% buffer research-only; production buffer remains 0.30%.; ETH Golden Path market coverage is still below developing maturity.; Pool-depth ladder evidence has no depth-ready route at requested paper size.; Closed paper-trade sample is below the 10-trade minimum for strategy confidence. |
...
- Fix provider/audit findings, regenerate reports, and rerun experiment evidence.
