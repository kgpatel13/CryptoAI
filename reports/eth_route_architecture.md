...
|---|---|---|---:|---:|---:|---:|---|
| WETH/USDC | True | Aerodrome, Uniswap V2, Uniswap V3 | 466 | 2024.3962 | 466 | 1558.3962 | Keep WETH/USDC on 0.30% production-paper evidence path. |
| USDC/WETH | True | Aerodrome, Uniswap V2, Uniswap V3 | 466 | 638.7480 | 466 | 172.7480 | Keep USDC/WETH on 0.30% production-paper evidence path. |

## Buffer Promotion Gates

| Gate | Passed | Observed |
|---|---|---|
| execution_cost_confidence_high | False | INSUFFICIENT |
| paper_slippage_samples_30_plus | False | 0 |
| quote_ok_rate_90_plus | True | 100.0000 |
| active_two_dex_eth_route | True | 1 |
| provider_not_critical | True | OK |
| report_audit_clean | False | 27 |
| candidate_has_30_plus_signals | True | 932 |
| candidate_avg_net_edge_0_03_plus | True | 0.2858 |
...
- `WATCH` 0.20% candidate replay has 932 positive signal(s) versus 932 at 0.30%, but promotion decision is KEEP_0_30_PRODUCTION_RESEARCH_0_20.
