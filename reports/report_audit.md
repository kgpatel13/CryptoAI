...
|---|---|---|
| CRITICAL | provider_monitor.json | Provider Monitor status is CRITICAL with 4 alert(s). |
| WATCH | quote_diagnostics.md | Quote Diagnostics has 2 error row(s) and 0 invalid row(s). |
| WATCH | paper_report.json | 6 legacy inverse-pair paper order(s) are annotated for accounting caution. |
| WATCH | opportunity_explorer.md | Current BUY opportunities are paper-simulated because only one healthy DEX venue is available. |
...
| portfolio_analytics.md | True | 2026-06-29T02:29:07Z | False | 4040 |
| strategy_center.json | True | 2026-06-29T02:29:02Z | False | 11064 |
| strategy_center.md | True | 2026-06-29T02:29:02Z | False | 2699 |
| feature_store.json | True | 2026-06-29T02:29:07Z | False | 1616 |
