...
def render_risk_controls() -> None:
    ...
    flags = {
        ...
        "CRYPTOAI_LIVE_ALLOWED_DEXES": os.getenv("CRYPTOAI_LIVE_ALLOWED_DEXES", "Uniswap V2,Uniswap V3,Aerodrome"),
        ...
        "CRYPTOAI_TINY_LIVE_SMOKE_USD": os.getenv("CRYPTOAI_TINY_LIVE_SMOKE_USD", "20"),
...
def render_system_health() -> None:
    ...
    for path in [
        ...
        REPORT_DIR / "live_shadow_gate.json",
        REPORT_DIR / "live_shadow_gate.md",
