...
with tab9:
    ...
    st.caption("v1.4 adds a simulated portfolio and position engine. No wallet connection.")
...
with tab10:
    ...
    st.caption("v1.5 creates simulated orders only. It never connects to a wallet.")
